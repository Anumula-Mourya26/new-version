...
class Transaction(Base):
    ...
    centre_id = Column(String(36), nullable=False)
    vendor_user_id = Column(String(36), nullable=True)
    ...
    proof_data = Column(Text, nullable=False)                       # UTR / Ref No. or base64/image reference
